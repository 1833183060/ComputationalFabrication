...
run('./OpenFab/OpenFab bunny.stl 10.0')
run('./OpenFab/OpenFab fandisk.stl 0.5')
run('./OpenFab/OpenFab spot.stl 0.25')
run('./OpenFab/OpenFab dragon.stl 1.0')
